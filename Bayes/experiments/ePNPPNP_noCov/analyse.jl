...
dif1 = chn_df[!,"a_w_s1[2]"]-chn_df[!,"a_w_s1[1]"]
dif2 = chn_df[!,"b_w_s1[2]"]-chn_df[!,"b_w_s1[1]"]
dif3 = chn_df[!,"a_w_s2[2]"]-chn_df[!,"a_w_s2[1]"]
dif4 = chn_df[!,"b_w_s2[2]"]-chn_df[!,"b_w_s2[1]"]
m1,l1,u1 = HDI(dif1)
m2,l2,u2 = HDI(dif2)
m3,l3,u3 = HDI(dif3)
m4,l4,u4 = HDI(dif4)
p = PlotlyJS.plot(box(
    name="Δa_w & Δb_w for EPNP (0,1) & PNP (2,3) with covariance plus covariance between ERPs",
    q1=[l1, l2,l3,l4],
    median=[m1, m2,m3,m4],
    q3=[u1, u2,u3,u4],
    mean=[m1, m2,m3,m4],
