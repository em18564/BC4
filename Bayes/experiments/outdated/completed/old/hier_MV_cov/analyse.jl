...
density(chn_df[!,"ab_w_1[2,2]"]-chn_df[!,"ab_w_1[2,1]"])
savefig("output/dif1.png")

density(chn_df[!,"ab_w_2[2,2]"]-chn_df[!,"ab_w_2[2,1]"])
savefig("output/dif2.png")

density(chn_df[!,"ab_w_3[2,2]"]-chn_df[!,"ab_w_3[2,1]"])
savefig("output/dif3.png")

density(chn_df[!,"ab_w_4[2,2]"]-chn_df[!,"ab_w_4[2,1]"])
savefig("output/dif4.png")

density(chn_df[!,"ab_w_5[2,2]"]-chn_df[!,"ab_w_5[2,1]"])
savefig("output/dif5.png")

density(chn_df[!,"ab_w_6[2,2]"]-chn_df[!,"ab_w_6[2,1]"])
savefig("output/dif6.png")
