...
chn = deserialize("experiments/hier_MV_cov/output/out.jls")
...
savefig("experiments/hier_MV_cov/output/dif2.png")
...
# savefig("experiments/hier_MV_cov/output/violin.png")

# ess_rhat_df = DataFrame(ess_rhat(chn))
# xs = ess_rhat_df[!,"rhat"]
# ys = ess_rhat_df[!,"ess"]
# scatter(xs, ys, xlabel = "rhat", ylabel = "ess", legend=false)
# savefig("experiments/hier_MV_cov/output/essRhat.png")
