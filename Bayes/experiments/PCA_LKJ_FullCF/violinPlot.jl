...
chn1 = deserialize("output_8/out1.jls")
chn2 = deserialize("output_8/out2.jls")
chn3 = deserialize("output_8/out3.jls")
chn4 = deserialize("output_8/out4.jls")
...
function HDIs(data)
    ...
    traces = [getBox(i,mdifs,ldifs,udifs) for i in range(1,length(wordTypes))]
...
Plots.savefig(essRhat,"output_8/essRhat.png")
