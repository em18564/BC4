...
shiftedSurps = renormaliseSurps(df_modified,NUM_TYPES)
mod=model_12_1(df_modified.Participant,df_modified.Word,shiftedSurps,df_modified.fullTag,dfPCA[:,pc],expMean,cauchyMean,NUM_TYPES,NUM_PARTICIPANTS)
