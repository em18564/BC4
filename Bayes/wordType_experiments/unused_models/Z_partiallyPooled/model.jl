...
mod=model_pp(df_modified.Participant,Int.(df_modified.Word),df_modified.Surprisal,df_modified.fullTag,dfPCA[:,pc],expMean,cauchyMean,NUM_TYPES,NUM_PARTICIPANTS,NUM_WORDS)
